...
// Use random helper: log a random number
console.log("Random helper value:", getRandomInt(1000));
} else {
...
buildScript();
console.log("✅ script generated and obfuscated: autoScript.js");
